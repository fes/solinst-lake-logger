...
format storage, or change Modbus registers.
...
RS-485 channels disabled. Never use it as wiring evidence.
...
Only Modbus read functions `0x03` and `0x04` are accepted.
