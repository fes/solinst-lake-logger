...
void testHttpRequestRoutesAreExactAndQueriesAreNotAccepted() {
  ...
  const Case cases[] = {
      ...
      {"POST /rs485/selftest HTTP/1.1", logger_core::HttpMethod::POST,
       logger_core::HttpRoute::RS485_SELFTEST,
       logger_core::HttpRouteDecision::RS485_SELFTEST, false},
      {"GET /rs485/selftest HTTP/1.1", logger_core::HttpMethod::GET,
       logger_core::HttpRoute::RS485_SELFTEST,
