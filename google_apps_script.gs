...
const HEADERS = [
  ...
  'weather_light_lux',
  'weather_last_error',
  'weather_summary_sample_count',
  'weather_summary_start_utc',
  'weather_summary_end_utc',
  'weather_air_temperature_c_avg',
  'weather_air_temperature_c_min',
  'weather_air_temperature_c_max',
  'weather_relative_humidity_pct_avg',
  'weather_relative_humidity_pct_min',
  'weather_relative_humidity_pct_max',
  'weather_barometric_pressure_hpa_avg',
  'weather_barometric_pressure_hpa_min',
  'weather_barometric_pressure_hpa_max',
  'weather_wind_speed_m_s_avg',
  'weather_wind_speed_m_s_min',
  'weather_wind_speed_m_s_max',
  'weather_wind_direction_deg_avg',
  'weather_light_lux_avg',
  'weather_light_lux_min',
  'weather_light_lux_max',
  'weather_rainfall_interval_mm',
  'weather_rainfall_counter_reset',
  'status'
];
...
function doPost(e) {
  try {
    ...
    const valuesByHeader = {
      ...
      water_valid: asBooleanOrBlank(data.water_valid),
      ...
      weather_summary_sample_count: asIntOrBlank(data.weather_summary_sample_count),
      weather_summary_start_utc: asString(data.weather_summary_start_utc),
      weather_summary_end_utc: asString(data.weather_summary_end_utc),
      weather_air_temperature_c_avg: asNumberOrBlank(data.weather_air_temperature_c_avg),
      weather_air_temperature_c_min: asNumberOrBlank(data.weather_air_temperature_c_min),
      weather_air_temperature_c_max: asNumberOrBlank(data.weather_air_temperature_c_max),
      weather_relative_humidity_pct_avg: asNumberOrBlank(data.weather_relative_humidity_pct_avg),
      weather_relative_humidity_pct_min: asNumberOrBlank(data.weather_relative_humidity_pct_min),
      weather_relative_humidity_pct_max: asNumberOrBlank(data.weather_relative_humidity_pct_max),
      weather_barometric_pressure_hpa_avg: asNumberOrBlank(data.weather_barometric_pressure_hpa_avg),
      weather_barometric_pressure_hpa_min: asNumberOrBlank(data.weather_barometric_pressure_hpa_min),
      weather_barometric_pressure_hpa_max: asNumberOrBlank(data.weather_barometric_pressure_hpa_max),
      weather_wind_speed_m_s_avg: asNumberOrBlank(data.weather_wind_speed_m_s_avg),
      weather_wind_speed_m_s_min: asNumberOrBlank(data.weather_wind_speed_m_s_min),
      weather_wind_speed_m_s_max: asNumberOrBlank(data.weather_wind_speed_m_s_max),
      weather_wind_direction_deg_avg: asNumberOrBlank(data.weather_wind_direction_deg_avg),
      weather_light_lux_avg: asNumberOrBlank(data.weather_light_lux_avg),
      weather_light_lux_min: asNumberOrBlank(data.weather_light_lux_min),
      weather_light_lux_max: asNumberOrBlank(data.weather_light_lux_max),
      weather_rainfall_interval_mm: asNumberOrBlank(data.weather_rainfall_interval_mm),
      weather_rainfall_counter_reset: asBooleanOrBlank(data.weather_rainfall_counter_reset),
